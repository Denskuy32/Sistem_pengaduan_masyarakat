...
@section('content')
        ...
        <form action="{{ url('/notifikasi') }}" method="POST" class="space-y-4">
            @csrf
            <div>
            ...
            <div>
                <label for="pesan_notifikasi" class="block text-gray-700 font-medium mb-2">pesan notifikasi:</label>
                <input type="text" id="pesan_notifikasi" name="pesan_notifikasi" value="{{ old('pesan_notifikasi') }}" required
                    class="w-full px-4 py-2 border border-gray-300 rounded focus:ring-2 focus:ring-blue-400 focus:outline-none">
            </div>
            <button type="submit"
